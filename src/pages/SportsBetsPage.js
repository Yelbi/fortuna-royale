          ...
          <div className="events-slider">
            {proximosEventos.map(evento => (
              <div key={evento.id} className="event-card">
                ...
                <button className="btn-secondary">Ver Cuotas</button>
              </div>
            ))}
          </div>
        </section>
            ...
            <div className="cards-grid">
              {apuestasFiltradas.map(apuesta => (
                <GameCard
                  ...
                  onButtonClick={() => console.log(`Viendo apuestas de ${apuesta.nombre}`)}
                />
              ))}
            </div>
          )}
        ...
        <section className="sports-live-section fade-in">
          <div className="live-betting-banner">
            <div className="live-content">
              ...
              <button className="btn-secondary">Ir a Apuestas en Vivo</button>
            </div>
          </div>
        </section>
      </div>
